...
set_property PACKAGE_PIN E19 [get_ports {start}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {read}]
set_property PACKAGE_PIN U19 [get_ports {read}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {write}]
set_property PACKAGE_PIN V19 [get_ports {write}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_in[3]}]
#set_property PACKAGE_PIN W18 [get_ports {d_in[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_in[4]}]
#set_property PACKAGE_PIN U15 [get_ports {d_in[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_in[5]}]
#set_property PACKAGE_PIN U14 [get_ports {d_in[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_in[6]}]
#set_property PACKAGE_PIN V14 [get_ports {d_in[7]}]					
...
#set_property PACKAGE_PIN U3 [get_ports {gain[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {gain[0]}]
#set_property PACKAGE_PIN P3 [get_ports {gain[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {gain[1]}]
#set_property PACKAGE_PIN N3 [get_ports {gain[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {gain[2]}]
#set_property PACKAGE_PIN P1 [get_ports {gain[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {gain[3]}]
#set_property PACKAGE_PIN L1 [get_ports {send}]					
...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {d_out}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_out}]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {out_gain}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {out_gain}]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {JB[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[2]}]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {SHUT}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {SHUT}]
##Sch name = JB7
